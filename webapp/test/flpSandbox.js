		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comlogaligroupmyfirstfoject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlogaligroupmyfirstfoject-display": {
								"semanticObject": "comlogaligroupmyfirstfoject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.logaligroup.myfirstfoject",
									"url": sap.ui.require.toUrl("com/logaligroup/myfirstfoject")
								}
							}
						}
					}
